...
export default class Voters extends Component {
  ...
  componentDidMount = async () => {
    ...
    if (this.props.loggedInUserId && this.props.token && this.props.userInfo.candidate_id !== null) {
      await axios
  ...
  render() {
    ...
    return (
      <div>
        <Search searchVoter={this.props.searchVoter} filteredDropDown={this.props.filteredDropDown} />
